...
def menu_apikey():
  ...
  id = "_".join(uuid)
  server = requests.get('https://github.com/Zunera20/Test1/blob/main/T.txt').text
...
==================================================   """)
  ...
  try:
    httpCaht = requests.get("https://github.com/Zunera20/Test1/blob/main/T.txt").text
    if id in httpCaht:
      ...
      os.system('xdg-open https://chat.whatsapp.com/HlUf2PFfQ1v7adqgaT1oAF')
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
